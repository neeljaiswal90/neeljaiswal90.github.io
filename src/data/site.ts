...
export const site = {
  ...
  description:
    'Senior Product Manager at Mint Mobile leading ecommerce growth, new-business launches, and four product managers. Explore evidence-qualified outcomes and operating systems.',
  language: 'en-US',
...
export const productionSections: readonly ProductionSectionRecord[] = [
  {
    ...
    claimIds: [
      ...
      'career.mint.scope',
      'career.mint.direct_reports_four_pm',
